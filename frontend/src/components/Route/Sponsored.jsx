...
const Sponsored = () => {
  return (
    <div
      className={`${styles.section} hidden sm:block bg-white py-10 px-5 mb-12 cursor-pointer rounded-xl hover:bg-blue-light transition duration-300 ease-out `}
    >
      <div className="flex justify-between w-full">
        ...
        <div className="flex items-start">
          <img
            src="https://static.vecteezy.com/system/resources/previews/016/460/772/original/lenovo-company-logo-with-realistic-shadow-popular-computer-and-laptop-manufacturing-companies-logotype-free-png.png"
            style={{width: '150px', objectFit: 'contain'}}
            alt=""
          />
        </div>
