        ...
        >
          {brandingData &&
            brandingData.map((i, index) => (
              <div
                className="flex items-start hover:bg-gradient-to-l hover:from-teal-200 hover:to-lime-200 focus:ring-4 focus:outline-none focus:ring-lime-200 dark:focus:ring-teal-700 p-5 "
                key={index}
              >
                {i.icon}
                <div className="px-3 ">
