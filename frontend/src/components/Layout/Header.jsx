...
const Header = ({activeHeading}) => {
  ...
  const handleSearchChange = (e) => {
    ...
    // const shopName = product.shop.toLowerCase();
  ...
  return (
    <>
          ...
          <div>
            ...
            >
              ...
              <span className="relative w-full text-left text-black transition-colors duration-300 ease-in-out group-hover:text-white">
                {isSeller ? 'Xem Shop' : 'Đăng ký người bán'}
              </span>
            </Link>
          </div>
        </div>
      ...
      <div
        ...
        } transition hidden 800px:flex items-center justify-between w-full bg-yellow h-[70px]`}
      >
          ...
          <div className="flex">
            <div className={`${styles.noramlFlex}`}>
              ...
              >
                ...
                <span className="absolute right-0 top-0 rounded-full bg-blue-dark w-4 h-4 top right p-0 m-0 text-white font-mono text-[12px] leading-tight text-center">
              ...
              <div className={`${styles.button} ml-4 !rounded-[4px]`}>
                <Link to="/shop-create">
                  <h1 className="text-[#fff] flex items-center">
                    Đăng ký người bán <IoIosArrowForward className="ml-1" />
                  </h1>
                </Link>
              </div>
              <br />
