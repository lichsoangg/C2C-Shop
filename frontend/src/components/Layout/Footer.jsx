...
const Footer = () => {
  return (
    <div className="bg-[#000] text-white">
      <div className="md:flex md:justify-between md:items-center sm:px-12 px-4 bg-yellow py-7">
        <h1 className="lg:text-4xl text-3xl md:mb-0 mb-6 lg:leading-normal font-semibold md:w-2/5">
          <span className="text-[#56d879] text-4xl animate-charcter ">Đăng ký </span> để nhận tin
          tức sự kiện và ưu đãi <br />
          hấp dẫn
        </h1>
        <div>
          <input
