...
const Address = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (addressType === '' || country === '' || city === '') {
      toast.error('Không được để trống trường này!');
    } else {
  ...
  return (
    <div className="w-full px-5">
      {open && (
        <div className="fixed w-full h-screen bg-[#0000004b] top-0 left-0 flex items-center justify-center ">
          <div className="w-[35%] h-[80vh] bg-white rounded shadow relative overflow-y-scroll">
            ...
            <h1 className="text-center text-[25px] font-Poppins">Thêm địa chỉ</h1>
            <div className="w-full">
      ...
      <div className="flex w-full items-center justify-between">
        <h1 className={` text-[25px] font-[600] text-[#000000ba] pb-2`}>Địa chỉ nhận hàng</h1>
        <div className={`${styles.button_2} !rounded-md`} onClick={() => setOpen(true)}>
      ...
      {user && user.addresses.length === 0 && (
        <h5 className="text-center pt-8 text-[18px]">Bạn chưa có địa chỉ nào !</h5>
      )}
    </div>
  );
};
