              ...
              <div className="w-full 800px:w-[50%] pt-5">
                ...
                <div className="flex items-center mt-12 justify-between">
                  <div className="flex items-center">
                    ...
                    <div className="bg-gray-200 text-gray-800 font-medium px-4 h-10 items-center flex ">
                      {count}
                    </div>
                    <button
                      className="bg-gradient-to-r from-teal-400 to-teal-500 text-white font-bold rounded-r  px-[13px] py-2 shadow-lg hover:opacity-75 transition duration-300 ease-in-out"
                ...
                <div
                  className={`${styles.button_2} w-[150px] !mt-6 !rounded !h-11 flex items-center`}
                ...
                <div className="flex items-center pt-8">
                  ...
                  <div className="pr-8">
                    ...
                    <h5 className="pb-3 text-[15px]">({averageRating}/5) Đánh giá</h5>
                  </div>
                  <div
      ...
      {active === 2 ? (
        <div className="w-full min-h-[40vh] flex flex-col items-center py-3 overflow-y-scroll">
          ...
          <div className="w-full flex justify-center">
            {data && data.reviews.length === 0 && <h5>Sản phẩm chưa có đánh giá nào!</h5>}
          </div>
        </div>
      ) : null}
          ...
          <div className="w-full 800px:w-[50%] mt-5 800px:mt-0 800px:flex flex-col items-end">
            <div className="text-left">
              <h5 className="font-[600]">
                Tham gia: <span className="font-[500]">{data.shop?.createdAt?.slice(0, 10)}</span>
              </h5>
