...
export const brandingData = [
  {
    ...
    Description: 'Dành cho đơn hàng từ 200.000 VNĐ',
    icon: (
      <svg
        width="36"
        height="36"
